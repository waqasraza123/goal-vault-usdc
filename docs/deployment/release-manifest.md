...
4. Confirm managed database plan, schema bundle, and parity plan are reviewed when persistence is changing.
...
8. Save the release manifest, managed database plan/schema/parity artifacts when applicable, and traffic plan artifacts with the release notes.
